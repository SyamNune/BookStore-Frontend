...
function About() {
  return (
    <div className="pt-28 relative min-h-screen overflow-hidden bg-gray-50 flex flex-col items-center justify-center">
      <div className="text-blue-900 mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2">
            <img
              src="https://images.pexels.com/photos/4861373/pexels-photo-4861373.jpeg"
            ...
            <div className="mt-4 flex items-center space-x-2">
              ...
              <span className="text-gray-700 text-lg">Active Library Members</span>
            </div>
          </div>

          {/* Text Section */}
          <div className="md:w-1/2 mt-8 md:mt-0 md:ml-8">
            <h2 className="text-4xl font-bold text-blue-800 mb-4 leading-tight">
              10+ Years of Building a  
              <span className="text-red-500"> Digital Library </span>  
              for Students & Researchers
            </h2>

            <p className="text-gray-700 mb-6 leading-relaxed">
              EDU-LIBRARY was founded with a mission to provide accessible, affordable, and 
              high-quality educational resources to students worldwide. Our digital library stores 
              textbooks, research papers, guides, project reports, and reference materials used across 
            ...
            <ul className="space-y-3 text-lg">
              <li className="flex items-center">
                ...
                Verified Textbooks & Study Materials
              </li>
              ...
              <li className="flex items-center">
                <span className="text-blue-600 mr-2">✔️</span>
                Curated Notes & Exam Preparation Guides
              </li>

              <li className="flex items-center">
                <span className="text-blue-600 mr-2">✔️</span>
                24/7 Student Help & Support System
              </li>
            </ul>
          </div>
